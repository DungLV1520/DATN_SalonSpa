...
export class WidgetsComponent implements OnInit {
  ...
  setcardnumber(e: any) {
    ...
    if (is_digit || is_delete) {
      ...
      (document.getElementById("card-num-elem") as HTMLElement).innerText =
        text;
    }
  }

  setname(ev: any) {
    (document.getElementById("card-holder-elem") as HTMLElement).innerHTML =
      ev.target.value;
  }

  setMonth(ev: any) {
    if (!ev.target.value) {
      (document.getElementById("expiry-month-elem") as HTMLElement).innerText =
        "00";
    } else {
      (document.getElementById("expiry-month-elem") as HTMLElement).innerText =
        ev.target.value;
  ...
  setYear(ev: any) {
    if (!ev.target.value) {
      (document.getElementById("expiry-year-elem") as HTMLElement).innerText =
        "00";
    } else {
      (document.getElementById("expiry-year-elem") as HTMLElement).innerText =
        ev.target.value;
  ...
  setCVC(ev: any) {
    (document.getElementById("cvc-elem") as HTMLElement).innerHTML =
      ev.target.value;
  }
  ...
  confirmcard() {
    if (this.cardForm.valid) {
      ...
      (
        document.getElementById("notification-overlay") as HTMLElement
      ...
      ).innerHTML = amount + " Payment Successfully";
    } else {
